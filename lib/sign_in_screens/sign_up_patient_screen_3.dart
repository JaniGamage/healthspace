...
import 'package:healthspace_test1/sign_in_screens/sign_up_screen_4.dart';
...
class SignUp_Patient_Screen_3 extends StatefulWidget {
  ...
  @override
  State<SignUp_Patient_Screen_3> createState() => _SignUp_Patient_Screen_3State();
}
  ...
  Widget build(BuildContext context) {
    return Form(
      ...
      child: Column(
        ...
        children: <Widget>[
          Center(child: Text('Contact Information' , style: TextStyle(fontSize: 25.0 , color: Colors.white , fontWeight: FontWeight.bold))),
          SizedBox(height: 10,),
            ...
            child: OutlinedButton(
              ...
              onPressed: () {
                if (_formKey.currentState!.validate()){
                  Navigator.push(context, MaterialPageRoute(builder: (_) => const SignUp_Patient_Screen_4()));
                }
