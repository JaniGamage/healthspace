...
class SignUp_Patient_Screen_4 extends StatefulWidget {
  ...
  @override
  State<SignUp_Patient_Screen_4> createState() => _SignUp_Patient_Screen_4State();
}
  ...
  Widget build(BuildContext context) {
    return Form(
      ...
      child: Column(
        ...
        children: <Widget>[
          Center(child: Text('Confirmation' , style: TextStyle(fontSize: 25.0 , color: Colors.white , fontWeight: FontWeight.bold))),
          SizedBox(height: 10,),
