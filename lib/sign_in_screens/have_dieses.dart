...
import 'package:healthspace_test1/sign_in_screens/signup_patient.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Text('Have you\nany\nDiseases?' , style: TextStyle(fontSize: 30.0 , color: Colors.white , decoration: TextDecoration.underline) , textAlign: TextAlign.center ,),
          // SizedBox(height: 10.0,),
          ...
          TextButton(onPressed: (){
            ...
            child: Container(
              child: Text('Yes' ,  style: TextStyle(fontSize: 30.0 , color: Colors.white), textAlign: TextAlign.center ,),
              width: 200.0,
              height: 50.0,
          ...
          TextButton(onPressed: (){
            ...
            child: Container(
              child: Text('No' ,  style: TextStyle(fontSize: 30.0 , color: Colors.white), textAlign: TextAlign.center ,),
              width: 200.0,
              height: 50.0,
              padding: EdgeInsets.all(10.0),
              decoration: BoxDecoration(
