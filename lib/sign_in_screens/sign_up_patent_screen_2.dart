...
class SignUp_Patient_Screen_2 extends StatefulWidget {
  ...
  @override
  State<SignUp_Patient_Screen_2> createState() => _SignUp_Patient_Screen_2State();
}
            ...
            child: OutlinedButton(
              ...
              onPressed: () {
                if (_formKey.currentState!.validate()){
                  Navigator.push(context, MaterialPageRoute(builder: (_) => const SignUp_Patient_Screen_3()));
                }
