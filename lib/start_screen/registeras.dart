            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context, MaterialPageRoute(builder: (_) => const SignUp_Patient()));//wenas krnna
                  },
                  child: const Text(
                    'Patient',
                    style: TextStyle(color: Color(0xFF179797), fontSize: 30),
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context, MaterialPageRoute(builder: (_) => const SignUp_Hospital()));
                  },
                  child: const Text(
                    'Hospital',
                    style: TextStyle(color: Color(0xFF179797), fontSize: 30),
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context, MaterialPageRoute(builder: (_) => const SignUp_Organization()));
                  },
                  child: const Text(
                    'Organization',
                    style: TextStyle(color: Color(0xFF179797), fontSize: 30),
